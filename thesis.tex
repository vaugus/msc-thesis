...
\input{tex/sections/blur-characterization-and-image-formation/main.tex}

\chapter{Theoretical Background}
\label{chapter:theoretical-background}
\input{tex/sections/theoretical-background/main.tex}
...
% \input{tex/sections/materials-and-methods}
...
%     \input{tex/appendix/fft-test-results}
    
%     \chapter{STFT Results}
%     \label{chapter:stft-test-results}
%     \input{tex/appendix/stft-test-results}
